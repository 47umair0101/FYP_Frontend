    ...
    const fetchData = async () => {
      try {
        ...
        if (userDataJSON) {
          ...
          // Parse the date string from local storage into a Date object
          const userDate = new Date(userData.user.date);
          setDate(userDate);
    ...
    <ScrollView style={{ flex: 1, backgroundColor: "#fff" }}>
      <View style={styles.container}>
        ...
        <Text style={styles.subHeading}>
          you can pdate your profile to enhance your experience with our vehicle
          services network.
        </Text>
