  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.menuItemsContainer}>
        <Pressable onPress={() => navigation.navigate("FuelAnalytics")}>
          <MenuItem heading={"Fuel Analytics"} icon={FuelAnalyticsIcon} />
        </Pressable>
        <Pressable onPress={() => navigation.navigate("CarWash")}>
          <MenuItem heading={"Car Wash"} icon={CarWashIcon} />
        </Pressable>
        <Pressable onPress={() => navigation.navigate("FuelDelivery")}>
          <MenuItem heading={"Fuel Delivery"} icon={FuelDeliveryIcon} />
        </Pressable>
        <Pressable onPress={() => navigation.navigate("NearestPump")}>
          <MenuItem heading={"Nearest Pump"} icon={NearestPetrolPump} />
        </Pressable>
        <Pressable onPress={() => navigation.navigate("CarBooking")}>
          <MenuItem heading={"Car Booking"} icon={CarBookingIcon} />
        </Pressable>
        <Pressable
          onPress={() => {
            navigation.navigate("HireMechanic");
          }}
        >
